...
train_file = "train_polyhope_spanish.csv"
val_file = "val_polyhope_spanish.csv"
...
sentiment = predict_sentiment(polyhope_inv_multi_labels, test_text, model, tokenizer, device)
